...
#
#   >docker build -t hellojest .
#
#Donde 'hellojest' puede ser cualquier nombre

#Para ejecutar usar el comando
#
#   >docker run -it --publish 7000:4000 hellojest
#
#Donde 'hellojest' es el nombre asignado cuando se compilo la imagen
